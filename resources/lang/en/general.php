...
return [
    ...
    'website_translate' => 'Website Translations',
    'work_with_us' => 'Work With Us',
    'contact' => 'Contact',
    'header_slider_1' => '<h2 class="whitecolor">To transpose ideas, it is the best term for TRANSLATIONS.</h2>',
    ...
    'header_slider_3' => '<h2 class="whitecolor">We are a reference, when the subject is translations.</h2>',
    'header_slider_4' => '<h2 class="whitecolor">Our company never stops!</h2>  <h2 class="whitecolor">Our team is at your disposal</h2> <h2 class="whitecolor">24 hours a day, 7 days a week,</h2> <h2 class="whitecolor">always ready to receive your project.</h2>',
    ...
    'home_services_text' => 'We are focused and specialized in market solutions and translations events. Come and see our services and make sure that you are choosing the best ones.',
    'home_services_btn' => 'learn about our services',

    //about
    'header_intro' => 'we are reference when the subject is translations',
    'about_first_sec' => 'Company history',
    'about_first_sec_header' => 'A new concept in translations',
